...
const ToolsLathePage = () => {
    const [activeTab, setActiveTab] = useState('lathe');
    ...
    return (
        <main className="min-h-screen bg-gray-50 p-8">
            <div className="max-w-7xl mx-auto space-y-8">
                <div className="mb-4">
                    <h1 className="text-3xl font-semibold text-gray-900">Tools Lathe</h1>
                    <p className="text-sm text-gray-600 mt-1">Kelola inventaris tools lathe dengan tampilan sederhana.</p>
                </div>

                <div className="flex flex-wrap gap-2 mb-6">
                    <button
                        onClick={() => setActiveTab('lathe')}
                        className={`px-4 py-2 rounded-lg font-medium ${activeTab === 'lathe' ? 'bg-blue-600 text-white' : 'bg-white text-gray-700 border'}`}>
                        Lathe
                    </button>
                </div>
                ...
                <section className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
                    <div className="mb-4">
                        <h2 className="text-lg font-semibold text-gray-900">Daftar Tools Lathe</h2>
                    </div>
